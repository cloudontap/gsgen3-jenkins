...
PRODUCT_DOCKER_EMAIL_VAR="${PRODUCT_DOCKER_PROVIDER}_EMAIL"
PRODUCT_DOCKER_EMAIL="${!PRODUCT_DOCKER_EMAIL_VAR}"
...
PRODUCT_REMOTE_DOCKER_EMAIL_VAR="${PRODUCT_REMOTE_DOCKER_PROVIDER}_EMAIL"
PRODUCT_REMOTE_DOCKER_EMAIL="${!PRODUCT_REMOTE_DOCKER_EMAIL_VAR}"
...
echo "PRODUCT_DOCKER_EMAIL=${PRODUCT_DOCKER_EMAIL}" >> ${WORKSPACE}/context.properties
...
echo "PRODUCT_REMOTE_DOCKER_EMAIL=${PRODUCT_REMOTE_DOCKER_EMAIL}" >> ${WORKSPACE}/context.properties
